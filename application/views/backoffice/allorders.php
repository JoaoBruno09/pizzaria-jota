    ...
    <div class="block_content">
        <div class="table-wrapper-scroll-y my-custom-scrollbar">
            <table class="table">
                ...
                <?php
                if ($get_all_orders_backoffice->num_rows() > 0) {
                    foreach ($get_all_orders_backoffice->result()as $row) {
                        ?>
                        <?php
                        echo '<tbody>';
